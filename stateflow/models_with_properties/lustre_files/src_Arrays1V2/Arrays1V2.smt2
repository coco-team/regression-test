...
(rule (=> 
  (and (and (or (not (= (not Arrays1_B_en.isInner) true))
       ...
       (= Arrays1_B_en.idArrays1_Arrays1 1023)
       )
...
(rule (=> 
  (and (and (or (not (= (not Arrays1_C_en.isInner) true))
       ...
       (= Arrays1_C_en.idArrays1_Arrays1 1024)
       )
...
(rule (=> 
  (and (and (or (not (= (not Arrays1_A_en.isInner) true))
       ...
       (= Arrays1_A_en.idArrays1_Arrays1 1022)
       )
...
(rule (=> 
  (and (= arrays1_arrays1__POINTArrays1_Arrays1_unless.__arrays1_arrays1__POINTArrays1_Arrays1_unless_7 (= arrays1_arrays1__POINTArrays1_Arrays1_unless.idArrays1_Arrays1_1 1024))
       (= arrays1_arrays1__POINTArrays1_Arrays1_unless.__arrays1_arrays1__POINTArrays1_Arrays1_unless_6 (= arrays1_arrays1__POINTArrays1_Arrays1_unless.idArrays1_Arrays1_1 1023))
       (= arrays1_arrays1__POINTArrays1_Arrays1_unless.__arrays1_arrays1__POINTArrays1_Arrays1_unless_5 (= arrays1_arrays1__POINTArrays1_Arrays1_unless.idArrays1_Arrays1_1 1022))
       (= arrays1_arrays1__POINTArrays1_Arrays1_unless.__arrays1_arrays1__POINTArrays1_Arrays1_unless_4 (and (= arrays1_arrays1__POINTArrays1_Arrays1_unless.idArrays1_Arrays1_1 1024) arrays1_arrays1__POINTArrays1_Arrays1_unless.E))
       (= arrays1_arrays1__POINTArrays1_Arrays1_unless.__arrays1_arrays1__POINTArrays1_Arrays1_unless_3 (and (= arrays1_arrays1__POINTArrays1_Arrays1_unless.idArrays1_Arrays1_1 1023) arrays1_arrays1__POINTArrays1_Arrays1_unless.F))
       (= arrays1_arrays1__POINTArrays1_Arrays1_unless.__arrays1_arrays1__POINTArrays1_Arrays1_unless_2 (and (= arrays1_arrays1__POINTArrays1_Arrays1_unless.idArrays1_Arrays1_1 1022) arrays1_arrays1__POINTArrays1_Arrays1_unless.E))
...
(declare-var Arrays1V2.i_virtual_local Real)
...
(rule (=> 
  (and (= Arrays1V2.ni_3._arrow._first_m Arrays1V2.ni_3._arrow._first_c)
       ...
       (and (or (not (= Arrays1V2.__Arrays1V2_1 true))
               (= Arrays1V2.i_virtual_local 0.))
            (or (not (= Arrays1V2.__Arrays1V2_1 false))
               (= Arrays1V2.i_virtual_local 1.))
       )
