...
(rule (=> 
  (and (and (or (not (= (not SetResetWait_Off_en.isInner) true))
       ...
       (= SetResetWait_Off_en.idSetResetWait_SetResetWait 1407)
       )
...
(rule (=> 
  (and (and (or (not (= (not SetResetWait_On_en.isInner) true))
       ...
       (= SetResetWait_On_en.idSetResetWait_SetResetWait 1406)
       )
...
(rule (=> 
  (and (and (or (not (= (not SetResetWait_Wait_en.isInner) true))
       ...
       (= SetResetWait_Wait_en.idSetResetWait_SetResetWait 1408)
       )
...
(rule (=> 
  (and (= setresetwait_setresetwait__POINTSetResetWait_SetResetWait_unless.__setresetwait_setresetwait__POINTSetResetWait_SetResetWait_unless_9 (= setresetwait_setresetwait__POINTSetResetWait_SetResetWait_unless.idSetResetWait_SetResetWait_1 1408))
       (= setresetwait_setresetwait__POINTSetResetWait_SetResetWait_unless.__setresetwait_setresetwait__POINTSetResetWait_SetResetWait_unless_8 (= setresetwait_setresetwait__POINTSetResetWait_SetResetWait_unless.idSetResetWait_SetResetWait_1 1407))
       (= setresetwait_setresetwait__POINTSetResetWait_SetResetWait_unless.__setresetwait_setresetwait__POINTSetResetWait_SetResetWait_unless_7 (= setresetwait_setresetwait__POINTSetResetWait_SetResetWait_unless.idSetResetWait_SetResetWait_1 1406))
       (= setresetwait_setresetwait__POINTSetResetWait_SetResetWait_unless.__setresetwait_setresetwait__POINTSetResetWait_SetResetWait_unless_6 (and (= setresetwait_setresetwait__POINTSetResetWait_SetResetWait_unless.idSetResetWait_SetResetWait_1 1408) setresetwait_setresetwait__POINTSetResetWait_SetResetWait_unless.Clear))
       (= setresetwait_setresetwait__POINTSetResetWait_SetResetWait_unless.__setresetwait_setresetwait__POINTSetResetWait_SetResetWait_unless_5 (and (= setresetwait_setresetwait__POINTSetResetWait_SetResetWait_unless.idSetResetWait_SetResetWait_1 1407) setresetwait_setresetwait__POINTSetResetWait_SetResetWait_unless.Suspend))
...
(declare-var SetResetWait.i_virtual_local Real)
...
(rule (=> 
  (and (= SetResetWait.ni_1._arrow._first_m SetResetWait.ni_1._arrow._first_c)
       ...
       (and (or (not (= SetResetWait.__SetResetWait_1 true))
               (= SetResetWait.i_virtual_local 0.))
            (or (not (= SetResetWait.__SetResetWait_1 false))
               (= SetResetWait.i_virtual_local 1.))
       )
