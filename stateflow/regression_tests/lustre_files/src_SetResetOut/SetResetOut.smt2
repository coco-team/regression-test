...
(rule (=> 
  (and (= SetResetOut_Off_en.__SetResetOut_Off_en_1 (not SetResetOut_Off_en.isInner))
       ...
       (= SetResetOut_Off_en.idSetResetOut_SetResetOut 514)
       )
...
(rule (=> 
  (and (= SetResetOut_On_en.__SetResetOut_On_en_1 (not SetResetOut_On_en.isInner))
       ...
       (= SetResetOut_On_en.idSetResetOut_SetResetOut 513)
       )
...
(rule (=> 
  (and (= setresetout_setresetout__POINTSetResetOut_SetResetOut_unless.__setresetout_setresetout__POINTSetResetOut_SetResetOut_unless_5 (= setresetout_setresetout__POINTSetResetOut_SetResetOut_unless.idSetResetOut_SetResetOut_1 514))
       (= setresetout_setresetout__POINTSetResetOut_SetResetOut_unless.__setresetout_setresetout__POINTSetResetOut_SetResetOut_unless_4 (= setresetout_setresetout__POINTSetResetOut_SetResetOut_unless.idSetResetOut_SetResetOut_1 513))
       (= setresetout_setresetout__POINTSetResetOut_SetResetOut_unless.__setresetout_setresetout__POINTSetResetOut_SetResetOut_unless_3 (and (= setresetout_setresetout__POINTSetResetOut_SetResetOut_unless.idSetResetOut_SetResetOut_1 514) setresetout_setresetout__POINTSetResetOut_SetResetOut_unless.Set))
       (= setresetout_setresetout__POINTSetResetOut_SetResetOut_unless.__setresetout_setresetout__POINTSetResetOut_SetResetOut_unless_2 (and (= setresetout_setresetout__POINTSetResetOut_SetResetOut_unless.idSetResetOut_SetResetOut_1 513) setresetout_setresetout__POINTSetResetOut_SetResetOut_unless.Reset))
