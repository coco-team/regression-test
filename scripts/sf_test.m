function result = sf_test(count,cocoSim_path, show_models)
bdclose('all')
if ~exist('count', 'var')
    count = 1;
end
...
tool_path = fullfile(this_tool,'../stateflow/regression_tests');

addpath(fullfile(this_tool,'../stateflow/regression_tests'));
