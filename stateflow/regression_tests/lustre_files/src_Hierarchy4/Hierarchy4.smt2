...
(rule (=> 
  (and (and (or (not (= (not Hierarchy4_A_en.isInner) true))
       ...
       (= Hierarchy4_A_en.idHierarchy4_Hierarchy4 1777)
       )
...
(rule (=> 
  (and (and (or (not (= (not Hierarchy4_B_en.isInner) true))
       ...
       (= Hierarchy4_B_en.idHierarchy4_Hierarchy4 1778)
       )
...
(rule (=> 
  (and (= hierarchy4_hierarchy4__POINTHierarchy4_Hierarchy4_unless.__hierarchy4_hierarchy4__POINTHierarchy4_Hierarchy4_unless_4 (= hierarchy4_hierarchy4__POINTHierarchy4_Hierarchy4_unless.idHierarchy4_Hierarchy4_1 1778))
       (= hierarchy4_hierarchy4__POINTHierarchy4_Hierarchy4_unless.__hierarchy4_hierarchy4__POINTHierarchy4_Hierarchy4_unless_3 (= hierarchy4_hierarchy4__POINTHierarchy4_Hierarchy4_unless.idHierarchy4_Hierarchy4_1 1777))
