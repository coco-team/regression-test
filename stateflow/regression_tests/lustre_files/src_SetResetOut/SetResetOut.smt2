...
(rule (=> 
  (and (= SetResetOut_Off_en.__SetResetOut_Off_en_1 (not SetResetOut_Off_en.isInner))
       ...
       (= SetResetOut_Off_en.idSetResetOut_SetResetOut 1374)
       )
...
(rule (=> 
  (and (= SetResetOut_On_en.__SetResetOut_On_en_1 (not SetResetOut_On_en.isInner))
       ...
       (= SetResetOut_On_en.idSetResetOut_SetResetOut 1373)
       )
...
(rule (=> 
  (and (= setresetout_setresetout__POINTSetResetOut_SetResetOut_unless.__setresetout_setresetout__POINTSetResetOut_SetResetOut_unless_5 (= setresetout_setresetout__POINTSetResetOut_SetResetOut_unless.idSetResetOut_SetResetOut_1 1374))
       (= setresetout_setresetout__POINTSetResetOut_SetResetOut_unless.__setresetout_setresetout__POINTSetResetOut_SetResetOut_unless_4 (= setresetout_setresetout__POINTSetResetOut_SetResetOut_unless.idSetResetOut_SetResetOut_1 1373))
       (= setresetout_setresetout__POINTSetResetOut_SetResetOut_unless.__setresetout_setresetout__POINTSetResetOut_SetResetOut_unless_3 (and (= setresetout_setresetout__POINTSetResetOut_SetResetOut_unless.idSetResetOut_SetResetOut_1 1374) setresetout_setresetout__POINTSetResetOut_SetResetOut_unless.Set))
       (= setresetout_setresetout__POINTSetResetOut_SetResetOut_unless.__setresetout_setresetout__POINTSetResetOut_SetResetOut_unless_2 (and (= setresetout_setresetout__POINTSetResetOut_SetResetOut_unless.idSetResetOut_SetResetOut_1 1373) setresetout_setresetout__POINTSetResetOut_SetResetOut_unless.Reset))
...
(declare-var SetResetOut.i_virtual_local Real)
...
(rule (=> 
  (and (= SetResetOut.ni_1._arrow._first_m SetResetOut.ni_1._arrow._first_c)
       ...
       (and (or (not (= SetResetOut.__SetResetOut_1 true))
               (= SetResetOut.i_virtual_local 0.))
            (or (not (= SetResetOut.__SetResetOut_1 false))
               (= SetResetOut.i_virtual_local 1.))
       )
